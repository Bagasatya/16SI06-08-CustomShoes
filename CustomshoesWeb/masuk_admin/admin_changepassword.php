...
If ( !empty($_POST['pasw_lama']) AND
     !empty($_POST['pasw_baru']) AND
     !empty($_POST['pasw_baru2']) AND
 ...
 $isganti=@mysql_query("UPDATE admin SET password='".md5($_POST['pasw_baru'])."' ");
...
<form method="post">
 Password Lama:</br><input name="pasw_lama" type="password" class="texbox"></br>
 Password Baru:</br><input name="pasw_baru" type="password" class="texbox"></br>
