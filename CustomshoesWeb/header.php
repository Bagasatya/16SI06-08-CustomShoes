...
<div id="contact">
<ul>
       <li><i class="fa fa-phone-square"></i> Phone : 021- 6588545336576875</li>
       <li><i class="fa fa-envelope-o"></i> Email : customshoes@gmail.com</li>
       <li><i class="fa fa-building-o"></i> Office : Jl. Kaliurang km 12.5 </li>
...
<div id="header_content">	<!--start header conteent-->
	<ul>
	  ...
	  <li><a href="index.php?clear=y"><img src="images/shoes.png"></a></li>
	  <li> <?php
