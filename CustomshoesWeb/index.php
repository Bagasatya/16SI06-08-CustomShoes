...
<div id="bgslider">
	...
	<div class="ws_images"><ul>
		<li><img src="data1/images1/duhh.jpg" alt="" width="1000px" title="" id="wows1_0"/></li>
		<li><a href="http://wowslider.com/vf"><img src="data1/images1/duhhh.jpg" width="900px" alt="full screen slider" title="full screen slider" id="wows1_1"/></a></li>
		<li><img src="data1/images1/duh.jpg" width="900px" alt="" title="" id="wows1_2"/></li>
	</ul></div>
	<div class="ws_bullets"><div>
		<a href="#" title=""><img src="data1/tooltips1/duh.jpg" width="1000px" alt=""/></a>
		<a href="#" title="full screen slider"><img src="data1/tooltips1/duhh.jpg" width="900px" alt="full screen slider"/></a>
		<a href="#" title=""><img src="data1/tooltips1/duhhh.jpg" width="900px" alt=""/></a>
	</div></div>
...
<div id="bgslider">
    ...
    <div id="wowslider-container1">
    <div class="ws_images"><ul>
        <li><img src="data1/images/anu1.jpg" alt="" width="900px" title="" id="wows1_0"/></li>
        <li><a href="http://wowslider.com/vf"><img src="data1/images/anu2.jpg" width="900px" alt="full screen slider" title="full screen slider" id="wows1_1"/></a></li>
        <li><img src="data1/images/anu3.jpg" width="900px" alt="" title="" id="wows1_2"/></li>
    </ul></div>
    <div class="ws_bullets"><div>
        <a href="#" title=""><img src="data1/tooltips/anu2.jpg" width="900px" alt=""/></a>
        <a href="#" title="full screen slider"><img src="data1/tooltips/anu3.jpg" width="900px" alt="full screen slider"/></a>
        <a href="#" title=""><img src="data1/tooltips/anu1.jpg" width="900px" alt=""/></a>
    </div></div>
    <div class="ws_shadow"></div>
    </div>  
    <script type="text/javascript" src="engine1/wowslider.js"></script>
